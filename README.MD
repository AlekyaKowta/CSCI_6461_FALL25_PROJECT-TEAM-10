...
src/
 ├── main/java/
 │── core/               → MachineState, MachineController, and CPU logic
 │── core/cache/         → Cache implementation (Project 2)
 │── assembler/          → Assembler for ISA-compliant program loading
 │── ui/                 → Swing-based front panel simulator UI
